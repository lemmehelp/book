...
&emsp;&emsp;&emsp;<a href="#63">2、函数声明</a>  
...
## <a name="8">C++ 中的空格</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="28">C++ 中的类型限定符</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="38">3、逻辑运算符（与或非）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="42">C++ 中的运算符优先级</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="45">1、while 循环</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="48">4、嵌套的循环</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="50">1、C++break语句（达到条件提前终止）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="51">2、C++continue语句（额外增加一次判断，然后跳过原本执行的语句）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="53">无限循环</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="60">2、? : 运算符</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="64">3、函数参数</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="73">C++ 中数组其他相关内容详解</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="76">C++ 中的 String 类</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="78">什么是指针？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="79">C++ NULL指针</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="80">C++ 指针的算术运算</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="81">1、**递增一个指针**</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="82">2、递减一个指针</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="83">**3、指针的比较**</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="84">C++指针VS数组</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="85">C++指针数组</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="86">C++ 指向指针的指针（多级间接寻址）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="87">C++ 传递指针给函数</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="88">C++ 从函数返回指针/数组</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="89">C++ 指针总结及相关容易混淆概念</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="90">**一，内存和地址**</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="91">**二，指针的本质就是地址** </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="92">三，一些容易混淆的重要内容</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

##### <a name="93">1、常量指针与指针常量</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="94">2、指针与数组</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="95">**4、指针函数与函数指针**</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="96">C++ 引用（理解成一种特殊的指针）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="97">1、基本定义</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="98">2、把引用作为函数参数</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="99">3、把引用作为函数返回值</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="100">C++ 基本的输入输出</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

C++ 的 I/O 发生在流中，流是字节序列。如果字节流是从设备（如键盘、磁盘驱动器、网络连接等）流向内存，这叫做**输入操作**。如果字节流是从内存流向设备（如显示屏、打印机、磁盘驱动器、网络连接等），这叫做**输出操作**。

#### <a name="101">1、I/O 库头文件</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="102">2、标准输出流（cout）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="103">3、标准输入流（cin)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="104">4、标准错误流（cerr)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="105">5、标准日志流（clog)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="106">C++ 数据结构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="107">1、数据结构的定义</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="108">2、访问结构成员</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="109">3、结构作为函数参数</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="110">4、指向结构的指针</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="111">5、typedef关键字</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
